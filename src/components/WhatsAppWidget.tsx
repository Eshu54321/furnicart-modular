...
export default function WhatsAppWidget() {
  ...
  return (
    <motion.a
      ...
      className="fixed bottom-[24px] right-[24px] z-45 bg-[#25D366] text-white h-[48px] rounded-full shadow-[0_8px_30px_rgba(37,211,102,0.35)] flex items-center px-4 space-x-2 border border-white/10 hover:bg-[#20ba59] transition-all duration-300 cursor-pointer select-none"
