  ...
  return (
    <>
      ...
      <main className="flex-1 pt-[72px] bg-page-bg overflow-x-hidden">
            ...
            >
              <div>
                <ServiceCard
                  ...
                  iconName="Building2"
                  imageUrl="/images/Desking workstations/IMG-20191217-WA0022.jpg"
                  href="/products"
                />
              </div>
              <div>
                <ServiceCard
                  ...
                  iconName="Layers"
                  imageUrl="/images/Full height partition 80mm thk/IMG-20190516-WA0013.jpg"
                  href="/products"
                />
              </div>
              <div>
              ...
              <div>
                <ServiceCard
                  ...
                  iconName="Tv"
                  imageUrl="/images/Conference-Meeting table/WhatsApp Image 2026-05-29 at 10.11.02.jpeg"
                  href="/products"
                />
              </div>
              <div>
                <ServiceCard
                  ...
                  imageUrl="/images/Storages/DSC06383.JPG"
                  href="/products"
                />
              </div>
            </div>
            ...
            >
              <div>
                <ProjectCard
                  ...
                  image="/images/Workstations and cubicles with 4ft partitions/DSC00879.JPG"
              ...
              <div>
                <ProjectCard
                  ...
                  image="/images/Conference-Meeting table/DSC09095.JPG"
              ...
              <div>
                <ProjectCard
                  ...
                  image="/images/Full height partition 80mm thk/IMG-20190516-WA0018.jpg"
                  location="BKC, Mumbai"
        ...
        <section className="py-24 md:py-32 bg-section-alt border-y border-border/80">
          <Container className="grid grid-cols-1 lg:grid-cols-12 gap-16 items-center">
            ...
            <div ref={whyImageRef} className="lg:col-span-6 relative w-full h-[400px] md:h-[480px] rounded-[16px] overflow-hidden border border-border shadow-warm-soft">
              <Image
                src="/images/Workstations and cubicles with 4ft partitions/DSC06423.JPG"
        ...
        <section className="bg-secondary py-24 relative overflow-hidden border-y border-border/20">
          <div className="absolute inset-0 opacity-5 pointer-events-none wood-grain" />
          <Container className="relative z-10">
            <div className="flex flex-col items-center mb-12 text-center">
              <span className="font-sans text-xs font-bold uppercase tracking-widest text-primary mb-4 block animate-pulse-slow">Manufacturing Excellence</span>
              <h2 className="text-3xl md:text-5xl font-serif font-bold text-white mb-6">Inside Our Factory</h2>
              <p className="text-white/80 max-w-2xl font-sans text-sm md:text-base leading-relaxed">
                Take an exclusive look inside our manufacturing unit. Watch our state-of-the-art machinery in action as we craft precision modular furniture for top corporate brands.
              </p>
            </div>
